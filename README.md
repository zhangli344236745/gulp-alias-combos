...
```
npm install gulp-alias-combos --save-dev
```
...
gulp-alias-combos插件主要目的是合并seajs/requirejs中依赖的模块，会把所
...
var aliasCombo = require('gulp-alias-combos')
...
MIT @ [Peter Mu](https://github.com/zhangli344236745)
